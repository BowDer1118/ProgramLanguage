...
void display_cards(Card *cards, int len) {  //批次輸出Card結構體陣列 共len個元素
    puts("--------------------------------------------------------------------------------------------------------------------");
    puts("Name                        Colorless   White   Red   Green   Blue   Black   Type                  Power   Toughness");
    puts("--------------------------------------------------------------------------------------------------------------------");
